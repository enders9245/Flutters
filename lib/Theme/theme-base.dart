...
import 'package:calc_upeux/Theme/theme-base.dart';
...
class MaterialTheme {
  ...
  ThemeData theme(ColorScheme scheme) {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: textTheme.bodyLarge?.copyWith(color: scheme.onSurface),
  ...
  // Puedes implementar los otros esquemas si los necesitas también...
  static ColorScheme lightMediumContrastScheme() {
    // Define o reutiliza según el estilo deseado
    return lightScheme(); // por ahora, reutiliza el esquema base
  }

  static ColorScheme lightHighContrastScheme() {
    return lightScheme(); // reemplazar con esquema de alto contraste si lo tienes
  }
}
